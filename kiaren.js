...
client.lavalink = new LavalinkManager({
  // Build node config from environment with a 'secure' flag when using port 443
  nodes: [
    {
      ...
      // many public lavalink providers use TLS on port 443; explicitly set secure
      secure: String(process.env.LL_PORT) === '443' || process.env.LL_SECURE === 'true',
    },
  ],
